...
class CustomerAddressListView(LoginRequiredMixin, CustomerRequiredMixin, ListView):
...
class CustomerAddressCreateView(LoginRequiredMixin, CustomerRequiredMixin, SuccessMessageMixin, CreateView):
...
class CustomerAddressEditView(LoginRequiredMixin, CustomerRequiredMixin, SuccessMessageMixin, UpdateView):
...
class CustomerAddressDeleteView(LoginRequiredMixin, CustomerRequiredMixin, SuccessMessageMixin, DeleteView):
